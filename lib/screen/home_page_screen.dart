...
import 'package:flutterdiosample/screen/single_image_upload_with_data_screen.dart';
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: <Widget>[
            ...
            RaisedButton(
              child: Text("UPLOAD SINGLE IMAGE WITH DATA"),
              onPressed: () {
                nextActivity(context, SingleImageUploadWithDataScreen());
              },
            ),
          ],
        ),
